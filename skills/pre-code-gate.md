...
- **Don't let this gate replace `product-lens-pr-review`** — this is a pre-build gate for the plan; the PR review is a post-build gate for the shipped code. Both apply; neither substitutes for the other.
